...
<main role="main" class="main-content">
    <h2>Laporan Rekap Surat Keluar</h2>
    ...
    $(document).ready(function() {
        $('#printBtn').on('click', function() {
            ...
            $('#dataTable-1 tbody tr').each(function() {
                var rowDate = moment($(this).find('td').eq(5).text(), 'YYYY-MM-DD'); // Tanggal dari kolom ke-5
                if (rowDate.isBetween(startDate, endDate, null, '[]')) { // Memeriksa apakah tanggal dalam rentang
                    var row = {
                        ...
                        tanggal: $(this).find('td').eq(5).text(), // Tanggal
                    };
                    dataRows.push(row);
                }
            });
            ...
            setTimeout(function() {
                ...
                printWindow.document.write('<table><thead><tr><th>Instansi</th><th>Perihal</th><th>Kategori</th><th>Tanggal</th></tr></thead><tbody>');
